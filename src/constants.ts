...
// Hard cap on the base64 inline path of boond_documents_create. base64 is ~4/3
// of the binary size and the whole string must be regenerated by the model as a
// tool argument, so it's bounded by the model's output-token budget: beyond
// ~1 Mo of base64 (~750 Ko of file) the argument gets truncated (corrupt file).
